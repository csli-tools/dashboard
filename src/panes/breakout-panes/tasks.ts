...
const connectWebsockets = () => {
    ...
    ws.on('message', function message(data) {
        ...
        console.clear()
        console.log(`Task(s)\n------`)
        const agentInfo = shell.exec(`junod q wasm contract-state smart juno14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9skjuwg8  '{"get_tasks":{}}' --node http://localhost:26657 --output json`, {
            silent: true
        })
